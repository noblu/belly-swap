...
import bnbhLogo from '../assets/binance-coin-bnb-logo.png'
...
const style = {
  ...
  button: `flex items-center bg-[#191B1F] rounded-2xl mx-110  text-[0.9rem]  font-semibold cursor-pointer`,
  buttonPadding: `p-2 mx-4`,
      ...
      <div className={style.buttonsContainer}>
        <div className={`${style.button} ${style.buttonPadding}`}>
          <div className={style.buttonIconContainer}>
            <Image src={bnbhLogo} alt='eth logo' height={20} width={20} />
          </div>
